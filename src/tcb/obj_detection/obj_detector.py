...
class ObjDetector():
    ...
    def predict(self, image_path, thresh=0.8):
...
if __name__ == '__main__':
    model_path = '~/ros_workspaces/tcb_workspace/model/inference_graph.pb'
    label_map_path = '~/ros_workspaces/tcb_workspace/model/labelmap.pbtxt'
    det = ObjDetector(model_path, label_map_path)
